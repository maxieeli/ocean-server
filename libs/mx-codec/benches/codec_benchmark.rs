...
use jwt_codec::{read_var_i32, read_var_u64, write_var_i32, write_var_u64};
...
fn codec(c: &mut Criterion) {
    ...
    {
        codec_group.bench_function("jwt encode var_int (32 bit)", |b| {
            b.iter(|| {
        ...
        codec_group.bench_function("jwt decode var_int (32 bit)", |b| {
            let mut encoder = Vec::with_capacity(BENCHMARK_SIZE as usize * 8);
            for i in 0..(BENCHMARK_SIZE as i32) {
                write_var_i32(&mut encoder, i).unwrap();
            }
    ...
    {
        codec_group.bench_function("jwt encode var_uint (32 bit)", |b| {
            b.iter(|| {
                let mut encoder = Vec::with_capacity(BENCHMARK_SIZE as usize * 8);
        ...
        codec_group.bench_function("jwt decode var_uint (32 bit)", |b| {
            let mut encoder = Vec::with_capacity(BENCHMARK_SIZE as usize * 8);
            for i in 0..BENCHMARK_SIZE {
                write_var_u64(&mut encoder, i as u64).unwrap();
            }
    ...
    {
        codec_group.bench_function("jwt encode var_uint (64 bit)", |b| {
            b.iter(|| {
                let mut encoder = Vec::with_capacity(BENCHMARK_SIZE as usize * 8);
        ...
        codec_group.bench_function("jwt decode var_uint (64 bit)", |b| {
            let mut encoder = Vec::with_capacity(BENCHMARK_SIZE as usize * 8);
            for i in 0..(BENCHMARK_SIZE as u64) {
                write_var_u64(&mut encoder, i).unwrap();
            }
